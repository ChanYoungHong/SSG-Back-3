...
public class LogBackConfig {
    ...
    private void createLoggers() {
        ...
        createLogger("com.spharosacademy.project.SSGBack", INFO, false);
        createLogger("com.spharosacademy.project.SSGBack.*..*Controller", DEBUG, false);
        createLogger("com.spharosacademy.project.SSGBack.*..*Service", WARN, false);
        createLogger("com.spharosacademy.project.SSGBack.*..*Repository", INFO, false);
        createLogger("com.spharosacademy.project.SSGBack.*..*security", DEBUG, false);
    }
